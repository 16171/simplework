...
@section('content')
    <div id="header-featured">
        <div id="banner-wrapper">
            <div id="banner" class="container">
                <h2>Просто домашняя страница</h2>
                <p>Это <strong>просто домашняя</strong> страница </p>
    ...
    <div id="wrapper">
        <div id="page" class="container">
            <div id="content">
                <div class="title">
                    <h1>Добро пожаловать к просто клиентам</h1>
                    <span class="byline">Здесь должен быть список клиентов</span> </div>
