...
@section('content')
    <div id="header-featured">
        <div id="banner-wrapper">
            <div id="banner" class="container">
                <h2>Просто контакты</h2>
                <p>Это <strong>просто </strong> контакты </p>
    ...
    <div id="wrapper">
        <div id="page" class="container">
            <div id="content">
                <div class="title">
                    <h1>Добро пожаловать в контакты</h1>
                    <span class="byline">Здесь должен быть список контактов</span> </div>
